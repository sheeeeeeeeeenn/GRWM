...
function updateLives() {
  let lives = "";
  for (let i = 0; i < maxWrong - mistakes; i++) {
    lives += "❤️ "; // Add a heart for each remaining life
  }
...
function reset() {
  ...
  updateLives(); // Reset the lives display
...
generateButtons();
guessedWord();
updateLives(); // Initialize the lives display at game start
